...
const Blogs = () => {
    ...
    return (
        <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
            <h2 className='text-3xl bg-[#1313130D] text-[#131313] py-8 rounded-2xl font-bold text-center'>Explore your knowledge</h2>
            <Link to={`/blogs/${blogs[0].id}`} className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 dark:bg-gray-50">
                <img src={blogs[0].blog_img} alt="" className="object-cover w-full h-64 rounded-md sm:h-96 lg:col-span-7 " />
